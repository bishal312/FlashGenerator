        ...
        >
          ...
          <div className="text-sm text-gray-400 flex flex-col gap-1">
            ...
            <p>
              ...
              <span className="text-gray-100 font-medium">$500</span>
            </p>
          </div>

          <button
            type="submit"
            disabled={flashUSDT < 500 || isPending}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-lg text-lg font-medium transition disabled:opacity-50 mt-2 flex justify-center items-center"
          >
