...
const DashboardView = ({ userRecord, total, latestOrder }: Props) => {
  return (
    <div className="min-h-screen mt-16 text-sm sm:text-base w-full bg-gradient-to-br from-gray-950 via-gray-900 to-black text-gray-100 px-6 sm:px-8 md:px-10 lg:px-20 py-10 md:py-16 overflow-x-hidden">
